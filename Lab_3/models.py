...
# t_storage = db.Table(
#     'storage', metadata,
#     db.Column('container_id', db.ForeignKey('containers.container_id', ondelete='RESTRICT', onupdate='RESTRICT'), nullable=False),
#     db.Column('product_id', db.ForeignKey('products.product_id', ondelete='RESTRICT', onupdate='RESTRICT'), nullable=False),
#     db.Column('quantity', db.Numeric, nullable=False)
# )